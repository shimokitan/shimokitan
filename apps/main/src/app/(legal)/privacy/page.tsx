export default function PrivacyPage() {
    return (
        <>
            ...
            <p>We use the information we collect to provide, maintain, and improve our Services, to communicate with you about updates and news, and to respond to your comments and questions.</p>

            <h2>4. Data Sharing and Disclosure</h2>
            <p>We do not sell or rent your personal information to third parties. We may share information with service providers who perform services on our behalf, but only as necessary to perform those services.</p>
            ...
            <h2>7. Contact Us</h2>
            <p>If you have any questions or concerns about this Privacy Policy, please contact us at <a href="mailto:support@shimokitan.live">support@shimokitan.live</a>.</p>
        </>
    );
}
